...
public class InteractiveWeapon : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject player = null;                         // Reference to the player.
    private GameObject gameController;                        // Reference to the game controller.
    [SerializeField]
	private ShootBehaviour playerInventory = null;            // Player's inventory to store weapons.

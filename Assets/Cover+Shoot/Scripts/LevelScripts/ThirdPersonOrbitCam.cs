...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	void Awake()
	{
        ...
        GameObject tempJoystickTwo = canvas.gameObject.transform.GetChild(1).gameObject;
        ...
        if (tempJoystickTwo)
        {
            joystickTwo = tempJoystickTwo.GetComponent<FixedJoystick>();
        }
        else
        {
	...
	void Update()
	{
        ...
        horizontalOne = joystickOne.Horizontal;
        verticalOne = joystickOne.Vertical;
        horizontalTwo = joystickTwo.Horizontal;
        verticalTwo = joystickTwo.Vertical;
        ...
        // Joystick:
        angleH += Mathf.Clamp(horizontalTwo, -1, 1) * 60 * horizontalAimingSpeed * Time.deltaTime;
		angleV += Mathf.Clamp(verticalTwo, -1, 1) * 60 * verticalAimingSpeed * Time.deltaTime;
	...
	private void ClampHorizontal()
	{
		...
		float acc = Mathf.Clamp(horizontalTwo, -1, 1) * horizontalAimingSpeed;

...
public class MoveBehaviour : GenericBehaviour
{
    ...
    public int rotateSpeed = 80;                    //Rotate speed.
    ...
    /*
    private Rigidbody rigidbody;                    // Gets the refrence to RigidBody for MovePosition().
    GameObject tempJoystickOne;                    
    GameObject tempJoystickTwo;
    [SerializeField]
    public FixedJoystick joystickOne;               // Gets the refrence to JoyStickOne.
    [SerializeField]
    public FixedJoystick joystickTwo;               // Gets the refrence to JoyStickTwo.
    [SerializeField]
    GameObject canvas;                              // Gets the refrence to Canvas.
    [SerializeField]
    Vector3 tempVect;                               // Temporary Vector3 MovePosition(tempVect)
    */
